...
class TestToolGuardrailsMiddleware:
    def test_wrap_tool_call_supports_async_input_guardrail(self) -> None:
        async def allow_input(tool_call_data: dict[str, Any], agent_name: str) -> bool:
    ...
    async def test_awrap_tool_call_supports_async_input_guardrail(self) -> None:
        async def deny_input(tool_call_data: dict[str, Any], agent_name: str) -> bool:
            _ = (tool_call_data, agent_name)
            return False
    ...
    async def test_awrap_tool_call_supports_async_output_guardrail(self) -> None:
        async def deny_output(tool_output_data: dict[str, Any], agent_name: str) -> bool:
    ...
    async def test_awrap_tool_call_accepts_mixed_sync_and_async_guardrails(
        ...
        def allow_input(tool_call_data: dict[str, Any], agent_name: str) -> bool:
            _ = (tool_call_data, agent_name)
            return True

        async def allow_output(tool_output_data: dict[str, Any], agent_name: str) -> bool:
            _ = (tool_output_data, agent_name)
            return True
