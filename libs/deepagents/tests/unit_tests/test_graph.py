...
class TestCreateDeepAgentGuardrails:
    ...
    def test_passes_tool_guardrails_to_main_agent_constructor(self) -> None:
        ...
        def allow_tool_inputs(tool_call_data: dict, agent_name: str) -> bool:
            _ = (tool_call_data, agent_name)
            return True

        def allow_tool_outputs(tool_output_data: dict, agent_name: str) -> bool:
    ...
    def test_subagent_guardrails_inherit_and_override_defaults(self) -> None:
        ...
        def override_input(tool_call_data: dict, agent_name: str) -> bool:
            _ = (tool_call_data, agent_name)
            return True
